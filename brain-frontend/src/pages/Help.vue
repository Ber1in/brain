                  ...
                  <div class="timeline-content">
                    <div class="update-card">
                      ...
                      <ul>
                        ...
                        <li>质量保证平台切换分支/标签前后，增加取消已跟踪文件修改及清理未跟踪文件流程，以防用例相关操作影响源码</li>
                        <li>增加冷热重启功能健壮性，优先尝试远程lanplus/lan协议操作IPMI，再尝试ssh到主机本地执行ipmitool</li>
                      ...
                      <ul>
                        <li>修复质量保证平台扫描用例后，切换分支/标签后，界面显示的已扫描目录未清理及可选目录未更新的问题</li>
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          <section id="support" class="doc-section">
            ...
            <div class="section-content">
              ...
              <div class="footer-note">
                ...
                <p class="update-info">
                  <span>最后更新：2026年01月23日</span>
                  <span>当前版本：v2.0.6</span>
                </p>
              </div>
            </div>
          </section>
