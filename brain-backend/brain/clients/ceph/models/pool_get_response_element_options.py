...
class PoolGetResponseElementOptions(BaseModel):
    """
    PoolGetResponseElementOptions
    """
    ...
    pg_num_max: Optional[StrictInt] = None
    pg_num_min: Optional[StrictInt] = None
    __properties = ["compression_mode", "compression_algorithm", "compression_min_blob_size", "compression_max_blob_size", "compression_required_ratio", "pg_num_max", "pg_num_min"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PoolGetResponseElementOptions:
        """Create an instance of PoolGetResponseElementOptions from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PoolGetResponseElementOptions:
        """Create an instance of PoolGetResponseElementOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PoolGetResponseElementOptions.parse_obj(obj)

        _obj = PoolGetResponseElementOptions.parse_obj({
