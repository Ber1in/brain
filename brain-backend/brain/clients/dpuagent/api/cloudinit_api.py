...
class CloudinitApi:
    ...
    def create_cloudinit_dpu_agent_v1_cloudinit_create_post_with_http_info(self, cloud_init_request : CloudInitRequest, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CloudInitResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_cloudinit_dpu_agent_v1_cloudinit_create_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['cloud_init_request'] is not None:
            _body_params = _params['cloud_init_request']
        ...
        _response_types_map = {
            '200': "CloudInitResponse",
            '422': "HTTPValidationError",
        }

        return self.api_client.call_api(
            '/dpu_agent/v1/cloudinit/create', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def delete_cloudinit_dpu_agent_v1_cloudinit_delete_post_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_cloudinit_dpu_agent_v1_cloudinit_delete_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/dpu_agent/v1/cloudinit/delete', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
