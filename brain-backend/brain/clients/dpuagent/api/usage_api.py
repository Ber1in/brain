...
class UsageApi:
    ...
    def get_uuid_usage_dpu_agent_v1_uuid_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(UuidUsageResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_uuid_usage_dpu_agent_v1_uuid_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
