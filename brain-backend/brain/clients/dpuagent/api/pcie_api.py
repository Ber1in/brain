...
class PcieApi:
    ...
    def set_pcie_qos_dpu_agent_v1_pcieqos_set_post_with_http_info(self, qos_ratio_request : QosRatioRequest, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method set_pcie_qos_dpu_agent_v1_pcieqos_set_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['qos_ratio_request'] is not None:
            _body_params = _params['qos_ratio_request']
