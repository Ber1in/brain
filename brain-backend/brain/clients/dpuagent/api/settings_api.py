...
class SettingsApi:
    ...
    def enable_pxe_dpu_agent_v1_settings_clouddisk_enable_put_with_http_info(self, cloud_disk_enable_request : CloudDiskEnableRequest, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method enable_pxe_dpu_agent_v1_settings_clouddisk_enable_put" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['cloud_disk_enable_request'] is not None:
            _body_params = _params['cloud_disk_enable_request']
        ...
        return self.api_client.call_api(
            '/dpu_agent/v1/settings/clouddisk_enable', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def get_clouddisk_enable_setting_dpu_agent_v1_settings_clouddisk_enable_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CloudDiskResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_clouddisk_enable_setting_dpu_agent_v1_settings_clouddisk_enable_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/dpu_agent/v1/settings/clouddisk_enable', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
