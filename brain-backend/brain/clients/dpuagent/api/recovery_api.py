...
class RecoveryApi:
    ...
    def query_recovery_mode_dpu_agent_v1_recoverymode_query_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(RecoveryModeResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method query_recovery_mode_dpu_agent_v1_recoverymode_query_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/dpu_agent/v1/recoverymode/query', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
